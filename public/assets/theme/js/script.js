...
window.onload = function(){
  ...
  var canvasFire = document.getElementById("canvasFire"),
      ctx = canvasFire.getContext("2d");
  
/*    var canvasDragon = document.getElementById("canvasDragon"),
      ctx2 = canvasDragon.getContext("2d");
...
*/
  ...
  var colors = ["#fdcf58", "#800909", "#f27d0c"];
  ...
  function generate(){
    this.x = pos.x;
    this.y = pos.y;
    this.radius = randomize(10,15);
    this.color = colors[Math.floor(Math.random() * colors.length)];
    this.vx = randomize(20,5 );
    this.vy = randomize(1, -1);
    this.life = randomize(15, 25);
  };
...
var x = setInterval(function() {
    ...
    if (distance < 0) {
        clearInterval(x);
        document.getElementById("timer").innerHTML = "Watch Live";
    }
}, 1000);
} 
else 
...
var ringer = {
    ...
    unit: function(idx,label,ring) {
      ...
      // first circle
      $r.ctx.strokeStyle = "rgba(40,53,147,0.5)";
      $r.ctx.beginPath();
      ...
      // second circle
      $r.ctx.strokeStyle = "rgba(40,53,147,1)";
      $r.ctx.beginPath();
